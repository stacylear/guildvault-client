...
import landingimg2 from "../../assets/linkedin-sales-solutions-u3hmzw5U-SI-unsplash.jpg";
import landingimg3 from "../../assets/micheile-dot-com-SoT4-mZhyhE-unsplash.jpg";
              ...
              <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
                ...
                <div className="w-full md:flex-1 md:pt-3">
                  ...
                  <p className="text-coolGray-500 font-medium">
                    Use our software to manage all your accounts in one place.
                  </p>
                </div>
              </div>
              <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
        ...
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            ...
            <h1 className="mb-4 text-3xl md:text-4xl leading-tight font-heading font-bold">
              Save Time and Money with Guild Vault
            </h1>
          ...
          <div className="relative max-w-4xl mx-auto">
            <img
            className="rounded-md pb-50"
              src={landingimg3}
              alt="Grow your money! Photo by micheile dot com on Unsplash"
            />
            <br></br>

            <p className="text-center text-gray-500">
            <a href="https://www.stacylear.com">Lear Creative Consulting</a> 
                  {/* <a href="https://github.com/stacylear"><i class="fa fa-github text-dark-grey hover-text-amber"></i></a>
			            <a href="https://twitter.com/StacyLearSDE"><i class="fa fa-twitter text-dark-grey hover-text-amber"></i></a>
			            <a href="https://www.linkedin.com/in/stacylear/"><i class="fa fa-linkedin text-dark-grey hover-text-amber"></i></a>
			            <br>
			            <a href="https://www.stacylear.com" target="_blank" class="text-dark-grey hover-text-amber">LEAR CREATIVE CONSULTING</a> */}
                </p>
          </div>
        </div>        
      </section>
