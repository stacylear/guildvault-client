...
import landingimg from "../../assets/kostiantyn-li-1sCXwVoqKAw-unsplash.jpg";
            ...
            <div className="flex flex-wrap xl:items-center -mx-4">
              <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                ...
                <p className="mb-8 text-lg md:text-xl text-gray-500 font-medium">
                  ...
                  complicated budgeting software? Try Guild Vault, the simple way to track your
              ...
              <div className="w-full md:w-1/2 px-4">
                <div className="relative mx-auto md:mr-0 max-w-max">
                  <img
                    ...
                    src={landingimg}
                     alt="House built out of money - photo by Kostiantyn Li on Unsplash"
                  />
                </div>
              </div>
            </div>
