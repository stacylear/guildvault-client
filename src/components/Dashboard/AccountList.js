      ...
      <section className="py-24 bg-white">
        <div className="container px-4 mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            {/* If user has no accounts, do not display the account list, and instead display the no accounts found message and button to create a new account. */}
            {accounts?.length <= 0 ? (
              <>
              ...
              <>
                ...
                <div className="max-w-4xl mx-auto mb-12 text-center">
                  ...
                  {/* <Link
                    ...
                    className="inline-flex m-8 items-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    <svg
                ...
                {/* Loop through all of the user's accounts and display them. */}
                {accounts?.map(acc => {
                  return (
