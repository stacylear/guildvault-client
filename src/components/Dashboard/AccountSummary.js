// This file is called in the AccountDashboard.js file and will show the total income and expenses for all accounts for a given user. Currently this is only an example of how this would look. The JavaScript needs to be implemented to provide functionality, then the reference can be uncommented in the AccountDashboard.js file.
    ...
    <>
      <div className="max-w-4xl mx-auto mb-12 text-center">
        <h3 className="mb-4 text-3xl md:text-4xl leading-tight text-coolGray-900 font-bold tracking-tighter">
          Total Income and Expenses for all Accounts
        </h3>
        <p className="text-lg md:text-xl text-coolGray-500 font-medium">
          A list of your accounts, separated by category, or in
          chronological order.
        </p>
      </div>
